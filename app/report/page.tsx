...
export default function ReportPage() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      const prompt = `You are an expert in waste management. Classify the waste shown in this image. Provide:
1. Type of waste (e.g., plastic, glass, paper, metal, organic).
2. Estimate the amount or weight in kilograms or liters.
3. Provide your confidence level in percentage, where 0 is unsure and 100 is certain.
4. Any additional suggestions for managing or recycling this waste.
  ...
  <div>
    ...
    <input
      ...
      id="type"
      name="type"
      value={newReport.type || (verificationStatus === 'success' && verificationResult?.wasteType) || ''}
      onChange={handleInputChange}
      required
      className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
      placeholder="Enter or modify waste type"
    />
  </div>
  ...
  <div>
    ...
    <input
      ...
      id="amount"
      name="amount"
      value={newReport.amount || (verificationStatus === 'success' && verificationResult?.quantity) || ''}
      onChange={handleInputChange}
      required
      className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 transition-all duration-300"
      placeholder="Enter or modify estimated amount"
    />
  </div>
</div>
        </div>
